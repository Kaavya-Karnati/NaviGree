            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="team-item bg-white shadow-md rounded-lg p-6 text-center transition-transform transform hover:scale-105">
                        <img src={RishiImage} className="w-32 h-32 mx-auto" alt="Rishitha Bura" />
                    ...
                    <div className="team-item bg-white shadow-md rounded-lg p-6 text-center transition-transform transform hover:scale-105">
                        <img src={imagesOTR12294} className="w-32 h-32 mx-auto" alt="Will Gan" />
                    ...
                    <div className="team-item bg-white shadow-md rounded-lg p-6 text-center transition-transform transform hover:scale-105">
                        <img src={KaavyaImage} className="w-32 h-32 mx-auto" alt="Kaavya Karnati" />
